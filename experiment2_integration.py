...
# run harmony data intergration

# Run Harmony to correct for sample and condition effects
sce.pp.harmony_integrate(adata_hvg, key=['experiment', 'ground_truth'], basis="pca", adjusted_basis="X_harmony")
...
sc.pl.umap(adata_hvg, color = "experiment")
